...
import sys
sys.path.append('/workspace/OesopStomach/code/v9.others/models/CenterNet')
...
class CenterNet_Resnet50(nn.Module):
    def __init__(self, num_classes = 20, pretrained = False):
        ...
        self.head = DetectorHead(nc=num_classes, ch=[64, 64], stride=[4.0, 4.0])
...
if __name__ == '__main__':
    ...
    net = CenterNet_Resnet50(4, pretrained=False).cuda()
    y = net(x)
    net = net.train()
    y = net(x)
    print(type(y))
