...
import sys
sys.path.append('/workspace/OesopStomach/code/v9.others/models/Cascade-rcnn')
from utils.config import cfg    # rm 'lib.', or cfg will create a new copy
...
from rpn.bbox_transform import bbox_transform_inv, clip_boxes, bbox_decode
