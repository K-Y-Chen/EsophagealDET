...
from models.yolo import Model, PromptDetectionModel
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        # model = YOHOunet(num_classes=nc, pretrained=False, backbone='resnet34').to(device)
        model = resnet50(num_classes=4, pretrained=False).to(device)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, modal_targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with torch.cuda.amp.autocast(amp):
                ...
                # print(pred[1][0].shape, pred[1][1].shape)
                print([p.shape for p in pred[0]])
                print([p.shape for p in pred[1]])
